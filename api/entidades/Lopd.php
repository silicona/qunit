...
class Lopd {
	...
	public $textos = array(
		...
		'text19' => 'Ficheros en papel.<br>El acceso a la documentación se limita exclusivamente al personal autorizado. Se establece el siguiente mecanismo para identificar los accesos realizados en el caso de los documentos relacionados con los datos de los empleados:<ol><li>Mediante documento digital donde se identifica a la persona que accede a la documentación, hora y fecha, tipo de documentos y uso.</li></ol>',
