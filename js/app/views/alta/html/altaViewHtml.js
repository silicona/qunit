        ...
        '<div class="card">',
            ...
            '<div class="card-body card-padding">',
                ...
                '<ul class="tab-nav text-center tabs_alta_clientes">',
                    ...
                    '<li ><a href="#tab2" data-pos="2" data-toggle="tab">Ocupación</a></li>',
                    '<li ><a href="#tab3" data-pos="3" data-toggle="tab">Alta</a></li>',
                '</ul>',
                    ...
                    '<div class="tab-content">',
                        ...
                        '<div class="tab-pane fade" id="tab2">',
                            ...
                            '<div>',
                                ...
                                '<h4>Ocupación de la empresa en MercaMadrid</h4>',

                                '<h5>Certificaciones</h5>',

                                '<p>¿Dispone de certificacion ecológica?</p>',

                                Fx.form_select({
                                    label            : 'Certificación ecológica',
                                    id               : 'certificacion',
                                    clase            : 'form-control',
                                    col_bs_label     : 'col-sm-3',
                                ...
                                '<p>Por favor, especifique el género con el que comercia en MercaMadrid</p>',
                                ...
                                '<div class="row">',
                                    '<div id="div_frescos" class="col-lg-12"></div>',
                                '</div>',

                                '<hr>',

                                '<h5>Productos Envasados:</h5>',
                                '<div class="row">',
                                ...
                                '<div class="row">',
                                    '<div id="div_envasados" class="col-lg-12"></div>',
                                '</div>',
                            ...
                            '<div>',
                                ...
                                '<p>Por favor, especifique el tipo de comercio de su empresa</p>',
                                ...
                                '<p>Por favor, especifique el destino o la procedencia del género</p>',

                                '<h5>Comercio nacional:</h5>',
                                '<div class="row">',
                                ...
                                '<div class="row">',
                                    '<div id="div_paises" class="col-lg-12"></div>',
                                '</div>',
